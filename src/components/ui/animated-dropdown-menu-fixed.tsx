...
export function AnimatedDropdownMenu({
  ...
  // Common button styles with the new gradient
  ...
  const dropdownMenuStyles = "absolute z-10 mt-1 w-full max-w-[150px] origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-10 focus:outline-none opacity-0 invisible transition-all duration-200 transform -translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0";
